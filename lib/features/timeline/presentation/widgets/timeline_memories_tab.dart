...
import 'package:memo/features/timeline/presentation/widgets/timeline_add_memory_button.dart';
import 'package:memo/features/timeline/presentation/widgets/timeline_memory_card.dart';
import 'package:memo/features/timeline/presentation/widgets/timeline_memory_state_sliver.dart';
    ...
    return state.when(
      ...
      success: (memories) {
        final filtered = _filter == null
            ? memories
            : memories
                  .where((memory) => _normalizeType(memory.type) == _filter)
                  .toList();
