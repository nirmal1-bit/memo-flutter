...
class VerificationSteps extends StatefulWidget {
  /// Real verification screens, one per step, e.g.:
  ///   screens: [IntroScreen(), CameraScreen(), ReviewScreen(), DoneScreen()]
...
class _VerificationStepsState extends State<VerificationSteps> {
  ...
  bool get _isLast => _activeStep == 6 - 1;
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: EasyStepper(
                  ...
                  steps: const [
                    EasyStep(icon: Icon(Icons.privacy_tip), title: 'Privacy'),
                    ...
                    EasyStep(icon: Icon(Icons.verified_rounded), title: 'Done'),
                  ],
            ...
            Expanded(
              child: AnimatedSwitcher(
                ...
                child: KeyedSubtree(
                  ...
                  // Swap for widget.screens[_activeStep] to render real screens
                  child: _activeStep == 2
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: ElevatedButton(
                      onPressed: _isLast ? null : _goToNext,
