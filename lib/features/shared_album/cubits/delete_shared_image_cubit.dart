...
class DeleteSharedImageCubit extends Cubit<BaseApiState<String>> {
  DeleteSharedImageCubit(this.sharedAlbumRepository) : super(const BaseApiState.initial());
  ...
  Future<void> deleteSharedImage(int connectionId, int imageId) async {
    ...
    final response = await sharedAlbumRepository.deleteSharedImage(connectionId, imageId);
