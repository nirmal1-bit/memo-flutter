...
@injectable
class GetSharedImagesCubit extends Cubit<BaseApiState<List<SharedImageResponse>>> {
  GetSharedImagesCubit(this.sharedAlbumRepository) : super(const BaseApiState.initial());
